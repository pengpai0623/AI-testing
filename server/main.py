...
# ========== 接口2：同步多轮对话（带会话管理） ==========
@app.post("/chat/session", response_model=SessionChatResponse, summary="同步多轮对话")
...
# ========== 接口3：异步多轮对话（带会话管理） ==========
@app.post("/chat/async_session", response_model=SessionChatResponse, summary="异步多轮对话")
...
# ========== 接口4：流式返回--基于requests ==========
@app.post("/chat/session_stream_requests", summary="多对话SSE流式输出(打字机)")
...
# ========== 接口5：流式返回--基于httpx ==========
@app.post("/chat/session_stream_httpx", summary="多对话SSE流式输出(打字机)")
